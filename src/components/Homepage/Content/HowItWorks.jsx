...
const HowItWorks = () => {
    return (
        <div className="text-center" id="how-it-works-section">
            ...
            <div className="grid">
                ...
                <div className="col-12 md:col-4 mb-4 px-5">
                    <Card title="Step 2: Tokenize" style={{ borderRadius: '10px' }}>
                        <p className="text-700 line-height-3">
                            Tokenize your Business using our easy-to-use interface.
                        </p>
                    </Card>
                </div>
                <div className="col-12 md:col-4 mb-4 px-5">
                    <Card title="Step 3: Invest" style={{ borderRadius: '10px' }}>
                        <p className="text-700 line-height-3">
                            Invest in other tokenized assets and manage your portfolio.
                        </p>
                    </Card>
                </div>
            </div>
