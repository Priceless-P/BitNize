...
const List = () => {
    ...
    const boughtTokenContractAddresses = boughtTokens.map((token) => token.asset.contractAddress);
    const allContractAddresses = [...assetContractAddresses, ...boughtTokenContractAddresses];
                            ...
                            {loadingAssets ? (
                                ...
                                >
                                    ...
                                    <Column
                                        ...
                                        body={renderPrice}
                                    ></Column>
                                    <Column field="assetContractAddress" header="Contract Address"></Column>
                                </DataTable>
                            )}
                        </Card>
                    </div>
                        ...
                        <Card title="Bought Tokens" headerClassName="small-header">
                            {loadingBoughtTokens ? (
                                ...
                                >
                                    ...
                                    ></Column>
                                    <Column field="asset.assetContractAddress" header="Contract Address"></Column>
                                    <Column field="transactionHash" header="Transaction" body={renderTransactionHash}></Column>
                                </DataTable>
                            )}
                        </Card>
                    </div>
